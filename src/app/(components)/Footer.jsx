...
export default function Footer() {
  return (
    <footer className="container flex items-center justify-center flex-col py-8 border-t-[1px]">
      ...
      <ul className="hidden md:flex justify-between w-2/6">
        <li><Link className={`text-md`} href="/">Home</Link></li>
        <li><Link className={`text-md`} href="/yt-videos">YT Videos</Link></li>
        <li><Link className={`text-md`} href="/blogs">Blogs</Link></li>
        <li><Link className={`text-md`} href="/contact">Contact</Link></li>
        <li><Link className={`text-md`} href="/about">About</Link></li>
      </ul>
    </footer>
  )
}