...
export default function YTVideo() {
    const { isLoading, data, error, isError, refetch } = useQuery({ queryKey: ['ytvideos'], queryFn: () => getChannelsVideos("date", 20, "videos"), staleTime: 86400000, retry: 1, refetchInterval: 86400000 });
    if (isError) {
